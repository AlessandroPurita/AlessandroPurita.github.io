const simulazioneCisia = {
    titolo: "Simulazione TEST ITA-L2 CISIA - Livello Iniziale, Avanzato e Superiore V6",
    parti: [
        // ==========================================
            ...
            strutture: [
                {
                    ...
                    quesiti: [
                        ...
                        { id: "p1_s1_3", spazio: "3", opzioni: { A: "studiare", B: "studiato", C: "studia" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p1_s1_4", espacio: "4", opzioni: { A: "lavora", B: "ha lavorato", C: "lavorava" }, rispostaCorretta: "A" }, // Spostata in A
                        { id: "p1_s1_5", spazio: "5", opzioni: { A: "simpatico", B: "simpatici", C: "simpatica" }, rispostaCorretta: "A" }  // Spostata in A
                    ]
                },
                {
                    ...
                    quesiti: [
                        { id: "p1_s2_1", spazio: "1", opzioni: { A: "riuscivate", B: "siete riusciti", C: "riuscirete" }, rispostaCorretta: "C" }, // Spostata in C
                        { id: "p1_s2_2", spazio: "2", opzioni: { A: "sentite", B: "sentirete", C: "sentivate" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p1_s2_3", spazio: "3", opzioni: { A: "buone", B: "buona", C: "buoni" }, rispostaCorretta: "A" }, // Spostata in A
                        { id: "p1_s2_4", spazio: "4", opzioni: { A: "siete", B: "sta", C: "state" }, rispostaCorretta: "C" }, // Spostata in C
                        { id: "p1_s2_5", spazio: "5", opzioni: { A: "lo", B: "vi", C: "gli" }, rispostaCorretta: "B" }  // Spostata in B
                    ]
                }
            ]
        },
            ...
            strutture: [
                {
                    ...
                    quesiti: [
                        { id: "p2_s1_1", spazio: "1", opzioni: { A: "abbia approvato", B: "approvasse", C: "approverà" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p2_s1_2", spazio: "2", opzioni: { A: "disporrà", B: "dispone", C: "disponga" }, rispostaCorretta: "C" }, // Spostata in C
                        { id: "p2_s1_3", spazio: "3", opzioni: { A: "saranno", B: "sarebbero", C: "fossero" }, rispostaCorretta: "A" },
                        { id: "p2_s1_4", spazio: "4", opzioni: { A: "nonostante", B: "visto", C: "affinché" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p2_s1_5", spazio: "5", opzioni: { A: "emetterà", B: "emette", C: "emetta" }, rispostaCorretta: "C" }  // Spostata in C
                    ]
                },
                {
                    titolo: "Secondo microtesto: L'evoluzione del mercato editoriale",
                    testo_bucato: "Negli ultimi anni la diffusione degli e-book ha modificato la filiera editoriale. Se gli editori avessero compreso subito la portata del fenomeno digitale, _ (1) _ investito prima nello sviluppo di piattaforme proprietarie. Ormai i lettori digitali si contano a milioni e la maggior parte delle case editrici _ (2) _ adatta a ritmi serrati alle nuove richieste del pubblico. Ciononostante, si teme che la pirateria informatica _ (3) _ danneggiare irreparabilmente il mercato degli autori emergenti. Gli esperti suggeriscono di adottare misure di protezione rigide, _ (4) _ gli utenti finali preferiscano comunque i canali di distribuzione legali. Sebbene il libro cartaceo mantenga il suo fascino, il digitale ha tracciato una strada da cui non _ (5) _ più indietro.",
                    quesiti: [
                        { id: "p2_s2_1", spazio: "1", opzioni: { A: "avessero", B: "avrebbero", C: "ebbero" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p2_s2_2", spazio: "2", opzioni: { A: "si è", B: "ci si", C: "vi si" }, rispostaCorretta: "A" },
                        { id: "p2_s2_3", spazio: "3", opzioni: { A: "può", B: "potesse", C: "possa" }, rispostaCorretta: "C" }, // Spostata in C
            ...
            comprensione: [
                {
                    ...
                    rispostaCorretta: "A",
                    spiegazione: "La critica risiede nell'aver teso a 'circoscrivere la lingua nell'alveo di un sistema chiuso di pure opposizioni concettuali' isolandola dal contesto biologico e sociale."
                },
                {
                    id: "p3_c2",
                    ...
                    rispostaCorretta: "B",
                    spiegazione: "La 'cognizione situata' definisce il significato come un 'processo plastico in perenne riconfigurazione incarnata (embodied)', generato dall'interazione tra mente e ambiente."
                },
                {
                    id: "p3_c3",
                    ...
                    rispostaCorretta: "C",
                    spiegazione: "Un dispositivo poietico 'opera [...] capace di plasmare i confini cognitivi entro cui l'esperienza stessa si manifesta', ovvero crea e struttura l'esperienza."
                },
                {
                    id: "p3_c4",
                    ...
                    rispostaCorretta: "B",
                    spiegazione: "Apprendere una L2 in contesti complessi 'comporta una vera e propria ristrutturazione delle mappe concettuali e delle architetture dell'attenzione logica'."
                },
                {
                    id: "p3_c5",
                    ...
                    rispostaCorretta: "B",
                    spiegazione: "La degenerazione in anarchia è impedita dall' 'esistenza di vincoli biologici condivisi e di regolarità sistemiche profonde'."
                },
                {
                    id: "p3_c6",
                    ...
                    rispostaCorretta: "B",
                    spiegazione: "La validità intersoggettiva denota un terreno logico comune e comprensibile tra differenti soggetti comunicanti."
                },
                {
                    id: "p3_c7",
                    ...
                    rispostaCorretta: "A",
                    spiegazione: "Si identifica nella 'capacità di transitare consapevolmente tra schemi concettuali eterogenei senza smarrire il nucleo logico profondo'."
                }
            ],
            strutture: [
                {
                    ...
                    quesiti: [
                        ...
                        { id: "p3_s1_2", spazio: "2", opzioni: { A: "si spoglierebbe", B: "si spoglia", C: "si spogli" }, rispostaCorretta: "C" }, // Spostata in C
                        { id: "p3_s1_3", spazio: "3", opzioni: { A: "risulterebbero", B: "risultano", C: "risultassero" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p3_s1_4", spazio: "4", opzioni: { A: "stante", B: "benché", C: "malgrado" }, rispostaCorretta: "A" },
                        { id: "p3_s1_5", spazio: "5", opzioni: { A: "rimarrebbe", B: "rimanga", C: "rimanesse" }, rispostaCorretta: "B" }  // Spostata in B
                    ]
                },
                {
                    ...
                    quesiti: [
                        { id: "p3_s2_1", spazio: "1", opzioni: { A: "avessero palesato", B: "palesassero", C: "paleserebbero" }, rispostaCorretta: "C" }, // Spostata in C
                        { id: "p3_s2_2", spazio: "2", opzioni: { A: "deve", B: "debba", C: "dovrebbe" }, rispostaCorretta: "B" }, // Spostata in B
                        { id: "p3_s2_3", spazio: "3", opzioni: { A: "sembra", B: "sembrasse", C: "sembri" }, rispostaCorretta: "C" }, // Spostata in C
                        { id: "p3_s2_4", spazio: "4", opzioni: { A: "affinché", B: "sebbene", C: "intanto che" }, rispostaCorretta: "A" },
                        { id: "p3_s2_5", spazio: "5", opzioni: { A: "sacfrichi", B: "sacrificherà", C: "sacrificasse" }, rispostaCorretta: "A" }
                    ]
                }
            ]
        }
